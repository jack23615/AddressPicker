...
@interface CustomModelTansition ()
//---保存入口传入的 试图控制器，用于操作
...
@implementation CustomModelTansition
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    containerView.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.4];
    if (!self.isDismiss)//---弹出
    {
        //---解决角度变换时，fromVC有一半会出现在 toVC上的bug
        fromVC.view.layer.zPosition = -200;
        toVC.view.layer.zPosition = 200;
